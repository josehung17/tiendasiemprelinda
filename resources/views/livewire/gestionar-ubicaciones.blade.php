<div class="p-4 sm:p-6 lg:p-8">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-xl font-semibold text-gray-900">Gestión de Ubicaciones y Zonas</h1>
            <p class="mt-2 text-sm text-gray-700">Administra los almacenes, tiendas y las zonas de almacenamiento dentro de cada uno.</p>
        </div>
                ...
                <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-300">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Ubicación</th>
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Tipo</th>
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Zonas</th>
                            ...
                            @forelse ($ubicaciones as $ubicacion)
                                <tr>
                                    <td class="py-4 pl-4 pr-3 text-sm sm:pl-6">
                                        ...
                                        <div class="text-gray-500">{{ $ubicacion->direccion }}</div>
                                    </td>
                                    <td class="px-3 py-4 text-sm text-gray-500">
                                        <span class="inline-flex rounded-full px-2 text-xs font-semibold leading-5 @if($ubicacion->tipo === 'almacen') bg-blue-100 text-blue-800 @else bg-green-100 text-green-800 @endif">
                                    ...
                                    <td class="px-3 py-4 text-sm text-gray-500">
                                        ...
                                        @else
                                            <span class="text-xs text-gray-400">Sin zonas definidas</span>
                                        @endif
                                    </td>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="mt-4 space-y-4">
                            ...
                            <div>
                                ...
                                <select wire:model.defer="tipo" id="tipo" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model.defer="direccion" id="direccion" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                        </div>
                    </div>
            ...
            <div x-show="show" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form wire:submit.prevent="saveZona">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="mt-4">
                            <label for="zonaNombre" class="block text-sm font-medium text-gray-700">Nombre de la Zona</label>
                            <input type="text" wire:model.defer="zonaNombre" id="zonaNombre" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
